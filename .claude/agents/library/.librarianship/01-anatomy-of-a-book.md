...
**The `author` link text is the author's name** — not the book title. The field says "author." The reader expects a name. `author: "[Libby](../..team/libby/libby-and-the-tended-garden/.cover.md)"` reads like a byline: *by Libby*. The link target is the autobiography — that's where you go to learn more. But what you *see* is the name, because that's how books work.

**The `links` entries use book titles** — because in that context you're listing related books, and the title identifies the book.

For canonical autobiographies, the author field is a **self-link**: `author: "[Libby](.cover.md)"`. See the self-link for why this matters.
