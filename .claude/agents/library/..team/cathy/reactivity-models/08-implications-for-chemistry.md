...
See the companion book [view-introspection](../view-introspection/.cover.md) for the full design, direct prior art (C# closure compilation, React Compiler), and implementation sketch.
...
2. **Read [view-introspection](../view-introspection/.cover.md)** — the full witness design, prior art, and implementation sketch.
