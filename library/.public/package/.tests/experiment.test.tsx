...
import { $Writing$, $Writing, Writing, $Type, $Composition, $Chapter, $Chapter$, TypeOfChapter, $TypeOfChapter, ChapterSpecification, TypeOfBook, Specification, specify, reflection } from '@dna-platform/public';
...
describe('EXPERIMENT — the class is flat and the hierarchy is carried in the others', () => {
    it('the kind stands as what its TYPE says it is — a cover is a chapter', () => {
        ...
        expect(cover.kind).toBeInstanceOf($TypeOfChapter);
    });
