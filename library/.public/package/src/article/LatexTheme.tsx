...
// Installed by the user or a module, globally `$(Book, Theme)(LatexTheme)` or per book on its derived component (Doug: "registration is done by the user or by another module… either global or by book"). The theme never carries formats.
...
export class $LatexTheme extends $Theme {
...
export const LatexTheme = $($LatexTheme);
