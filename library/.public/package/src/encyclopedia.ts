// @dna-platform/public/encyclopedia — Wikipedia as a book type.
// What ANY encyclopedia has and no other book type does; what any application writes around a
// book — its controls and its chrome — stands behind @dna-platform/public/application.
