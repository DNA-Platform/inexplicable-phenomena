...
import { Equation, Heading, Paragraph, Section } from '@dna-platform/public';
        ...
        <Section>
            ...
            <Section>
                ...
                <Section>
                    ...
                    <Paragraph>In Section 6.2.4, we saw how Smolensky [243] and Razborov [221] proved strong lower bounds against the class AC [p], or constant-depth, polynomial-size circuits of AND, OR, NOT, and MOD p gates, where p is prime. This left the frontier of circuit lower bounds as AC [m], where m is composite.</Paragraph>
