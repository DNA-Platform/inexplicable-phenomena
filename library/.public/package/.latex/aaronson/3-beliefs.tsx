            ...
            <Document>
                <Section>
                    ...
                    <Section>
                        ...
                        <Paragraph>Since the 1970s, there’s been speculation that P ≠ NP might be independent (that is, neither provable nor disprovable) from the standard axiom systems for mathematics, such as Zermelo- Fraenkel set theory. To be clear, this would mean that either<Citation>hartmanis</Citation></Paragraph>
                    </Section>
                </Section>
            </Document>
        );
