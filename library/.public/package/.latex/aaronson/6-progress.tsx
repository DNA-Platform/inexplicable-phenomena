...
import { Citation, Document, Equation, Heading, Paragraph, Section } from '@dna-platform/public';
                ...
                <Section>
                    ...
                    <Section>
                        ...
                        <Section>
                            ...
                            <Paragraph>To recap, PSPACE ⊆ IP is a non-relativizing inclusion of complexity classes. But can we leverage that achievement to prove non-relativizing separations between complexity classes, with an eye toward P ≠ NP? Certainly, by combining IP = PSPACE with the Space Hierarchy Theorem (which</Paragraph>
                        </Section>
                        <Section>
                            <Heading>The Algebrization Barrier</Heading>
                            <Paragraph>In 2008, Avi Wigderson and I <Citation>aaronson2009</Citation> showed that, alas, there’s a third barrier. In particular, while the arithmetic techniques used to prove IP = PSPACE do evade relativization, they crash up against a modified version of relativization that’s “wise” to those techniques. We called this modified barrier the algebraic relativization or algebrization barrier. We then showed that, in order to prove P ≠ NP—or for that matter, even to prove NEXP ⊂ P/poly, or otherwise go even slightly beyond the results of Section 6.3.2—we’d need techniques that evade the algebrization barrier (and also, of course, evade natural proofs). <Citation>aaronson2009</Citation></Paragraph>
                        </Section>
                    </Section>
                    <Section>
                        ...
                        <Section>
                            <Heading>NEXP ⊂ ACC</Heading>
                            <Paragraph>In Section 6.2.4, we saw how Smolensky <Citation>smolensky1987</Citation> and Razborov <Citation>razborov1987</Citation> proved strong lower bounds against the class AC [p], or constant-depth, polynomial-size circuits of AND, OR, NOT, and MOD p gates, where p is prime. This left the frontier of circuit lower bounds as AC [m], where m is composite. <Citation>williams2014c</Citation></Paragraph>
                    ...
                    <Section>
                        ...
                        <Paragraph>Besides Turing machines and Boolean circuits acting on bits, there’s another kind of computation that has enormous relevance to the attempt to prove P ≠ NP. Namely, we can consider computer programs that operate directly on elements of a field, such as the reals or complex numbers. Perhaps the easiest way to do this is via arithmetic circuits, which take as input a collection of elements x1, . . . , xn of a field F, and whose operations consist of adding or multiplying any two previous elements—or any previous element and any scalar from F—to produce a new F-element. We then</Paragraph>
                        <Section>
                    ...
                    <Section>
                        ...
                        <Section>
                            ...
                            <Paragraph>Because the permanent and determinant are characterized by their symmetries, and because they satisfy another technical property called “partial stability,” Mulmuley and Sohoni observe that a field called geometric invariant theory can be used to get a handle on their orbit closures. I won’t explain the details of how this works (which involve something called Luna’s Etale Slice Theorem´ <Citation>luna1973</Citation>), but will just state the punchline.</Paragraph>
                        </Section>
                        <Section>
                            <Heading>GCT and P = NP</Heading>
                            <Paragraph>Suppose—let’s dream—that everything above worked out perfectly. That is, suppose GCT led to the discovery of explicit obstructions for embedding the padded permanent into the determinant, and thence to a proof of Valiant’s Conjecture 72. How would GCT go even further, to prove P ≠ NP?</Paragraph>
                        </Section>
                        <Section>
