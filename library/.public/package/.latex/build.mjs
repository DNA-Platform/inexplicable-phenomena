...
const tooling = new Set(['build.mjs', 'verify-latex.mjs', 'main.tsx', 'index.html', 'vite.config.ts', 'tsconfig.json', 'node_modules', '.public']);
const skipped = (name) => tooling.has(name) || name.startsWith('.vite');
