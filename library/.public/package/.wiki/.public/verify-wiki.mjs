...
const targets = [
    {
        ...
        ours: '',
        regions: [
            ['wordmark', '.central-textlogo__image', 'header p.pd-logo img'],
            ['ring', '.central-featured', 'up:.pd-languages'],
            ...
            ['project card', '.other-project', '.pd-projects > div'],
            ['card title', '.other-project-title', '.pd-projects > div .pd-title'],
            ['card tagline', '.other-project-tagline', '.pd-projects > div p:last-child'],
        ],
        counts: [],
        landmarks: [],
    },
