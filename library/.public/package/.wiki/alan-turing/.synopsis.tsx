    ...
    print() {
        return (
            <Synopsis print>
                ...
                <Image source="https://thumb.wikimedia.org/wikipedia/en/thumb/9/94/Symbol_support_vote.svg/20px-Symbol_support_vote.svg.png?utm_source=en.wikipedia.org&utm_campaign=parser&utm_content=thumbnail" width="19px" height="20px">This is a good article. Click here for more information.</Image>
