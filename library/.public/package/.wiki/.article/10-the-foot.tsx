        ...
        return (
            <Footer>
                ...
                <Paragraph>
                    ...
                    <BookLink>[Mobile view](https://en.wikipedia.org/w/index.php?title=Wikipedia:Manual_of_Style/Layout&mobileaction=toggle_view_mobile)</BookLink>
                    <BookLink>[Edit preview settings](https://en.wikipedia.org/wiki/Wikipedia:Manual_of_Style/Layout#)</BookLink>
                </Paragraph>
            </Footer>
        );
    }
