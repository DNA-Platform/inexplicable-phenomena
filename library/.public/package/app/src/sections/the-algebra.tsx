...
const held: Shelved = shelve('algebra', '#5a2320', 540, algebra);
...
class $TheAlgebra extends $Chemical {
    open = false;
    page = 0;
    mode = 'read';
    writing = false;
...
export const TheAlgebra = $($TheAlgebra);
