        ...
        return (
            <>
                <Section>
                    ...
                    {'\n\nFour walks: the fold, where the paragraph earns its break; the chart, where a page maps its neighbourhood; the curvature, where meaning will not come back unchanged; and the geodesic, the straightest reading a curved book allows.'}
                </Section>
