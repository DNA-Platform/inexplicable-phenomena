        ...
        return (
            <>
                <Section>
                    ...
                    {'\n\nThe cover is filed the same way. Ask this book to stand for itself and it hands you its cover — the one reference that answers for the whole surface^[shelf].'}
                </Section>
                <Section>
