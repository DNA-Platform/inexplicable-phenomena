        ...
        return (
            <>
                <Section>
                    ...
                    {'\n\nThis page can prove it. The fold was creased in [its own chapter](#3); the crease itself was pressed in [the second section](#3.0). And a reference below the paragraph is a *highlighting*: follow [this very paragraph](#7.0.3) and watch it light and fade — a geodesic of exactly one step.'}
                </Section>
                <Section>
