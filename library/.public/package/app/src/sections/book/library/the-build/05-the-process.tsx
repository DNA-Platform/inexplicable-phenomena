...
const phases: Stage[] = [
    ...
    { name: 'resolving', takes: 'a description', makes: 'a library', where: 'the compiler', owed: 'the one phase nobody has built: where a name becomes a reference, and where what a cover left unsaid is supplied' },
