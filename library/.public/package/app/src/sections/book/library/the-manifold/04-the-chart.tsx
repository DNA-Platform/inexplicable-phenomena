        ...
        return (
            <>
                <Section>
                    ...
                    {'\n\nNo one reads a book; one reads a page. The page is a chart — a map $\\varphi: U \\to \\mathbb{R}^2$ from a patch of the book onto flat paper — and while you stand on it, the book obliges by seeming flat. Every difficulty of reading is the difficulty of a mapmaker: the surface is curved and the paper is not^[Which is why no honest page ever claims to be the whole book, and why a summary — a very small map of a very large country — always lies a little.].'}
