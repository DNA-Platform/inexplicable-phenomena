        ...
        return (
            <>
                <Section>
                    ...
                    {'\n\nGeometry has the instrument for this: parallel transport. Move a vector around a closed loop on a curved surface and it returns rotated, though at every step you were careful to keep it parallel^[The care is the point. Curvature is not a failure of attention; it is what the surface does to perfect attention.]. Flat books exist — glossaries, timetables — and their words come home unchanged. No one rereads a timetable to feel it differently.'}
                </Section>
                <Section>
