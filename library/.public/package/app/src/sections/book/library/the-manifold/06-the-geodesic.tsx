        ...
        return (
            <>
                <Section>
                    ...
                    {'\n\nEvery other route steers. The skimmer cuts across the surface and pays in [curvature](#5) they never felt — words arriving unturned, conclusions weightless. The index-chaser tunnels. Only the geodesic reader lets the book do all the turning^[pass].'}
                </Section>
                <Section>
