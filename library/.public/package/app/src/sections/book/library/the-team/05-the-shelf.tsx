        ...
        return (
            <>
                <Section>
                    ...
                    {'\n\n“You think an index card representation of something includes all words in it? No.” The whole text of a book is the first thing a card leaves off, and the leaving-off is what makes it worth consulting. A stand-in that reproduced the thing would be the thing, and you would be holding the book again.'}
