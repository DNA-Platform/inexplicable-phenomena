    ...
    view(): ReactNode {
        return (
            <Section>
                ...
                <Paragraph>{'By '}</Paragraph><Author for={theTeam}>The Team</Author>{'. Fiction, inspired by a true story, about the making of a shelf that turned out to be a library. It is on that shelf.'}
